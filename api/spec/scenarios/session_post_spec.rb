describe "POST /sessions" do
  ...
  context "CT-API001: Fluxo Principal - Login com sucesso" do
    before(:all) do
      payload = { email: "jqcaraujo@hotmail.com", password: "pwd123" }
  ...
  #       payload: { email: "jeremias@hotmail.com", password: "123" },
  #       code: 401,
  #       error: "Unauthorized",
  #     },
  #     {
  ...
  #       payload: { email: "jqcaraujo@hotmail.com", password: "" },
  #       code: 412,
  #       error: "required password",
  #     },
  #     {
  #       title: "CT-API007: Fluxo alternativo - Sem informar o campo Senha",
  #       payload: { email: "jqcaraujo@hotmail.com" },
  #       code: 412,
  #       error: "required password",
  #     },
  #   ]
  ...
  testSuit.each do |testCase|
    ...
    context "#{testCase[:title]}" do
      before(:all) do
        payload = { email: "jqcaraujo@hotmail.com", password: "123" }
